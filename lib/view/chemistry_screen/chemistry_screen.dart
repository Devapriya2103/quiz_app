...
class _ChemistryScreenState extends State<ChemistryScreen> {
            ...
            Expanded(
              child: Padding(
                        ...
                        child: InkWell(
                          onTap: () {
                            if (selectedAnsIndex == null) {
                              ...
                              if (selectedAnsIndex ==
                              DummyDb.chemistryQuestions[currentQuestionIndex]["answerIndex"]
                              ) {
                                rightAnsCount++;
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  Text(DummyDb.chemistryQuestions[currentQuestionIndex]["options"][optionIndex],
                ...
                Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      if (currentQuestionIndex < DummyDb.chemistryQuestions.length - 1) {
                      currentQuestionIndex++;
                      setState(() {});
  ...
  Color getColor (int clickedIndex) { 
    if (selectedAnsIndex != null) {
      if (DummyDb.chemistryQuestions[currentQuestionIndex]["answerIndex"] == clickedIndex) {
        return Colors.green;
      }
    }
    if (selectedAnsIndex == clickedIndex) {
      if (selectedAnsIndex == DummyDb.chemistryQuestions[currentQuestionIndex]["answerIndex"]) {  
        return Colors.green;  
      } else {
      return Colors.red;  
      } 
