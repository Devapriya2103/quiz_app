...
class _BiologyScreenState extends State<BiologyScreen> {
            ...
            Expanded(
              child: Padding(
                  ...
                  width: double.infinity,
                      ...
                      child: Stack(
                        children: [
                          Align(
                            alignment: Alignment.center,
                            child: Text(DummyDb.biologyQuestions[currentQuestionIndex]["question"],
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              fontSize: 15,
                              color: Colors.white,
                        ...
                        child: InkWell(
                          onTap: () {
                            if (selectedAnsIndex == null) {
                              ...
                              if (selectedAnsIndex ==
                              DummyDb.biologyQuestions[currentQuestionIndex]["answerIndex"]
                              ) {
                                rightAnsCount++;
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  Text(DummyDb.biologyQuestions[currentQuestionIndex]["options"][optionIndex],
                ...
                Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      if (currentQuestionIndex < DummyDb.biologyQuestions.length - 1) {
                      currentQuestionIndex++;
                      setState(() {});
  ...
  Color getColor (int clickedIndex) { 
    if (selectedAnsIndex != null) {
      if (DummyDb.biologyQuestions[currentQuestionIndex]["answerIndex"] == clickedIndex) {
        return Colors.green;
      }
    }
    if (selectedAnsIndex == clickedIndex) {
      if (selectedAnsIndex == DummyDb.biologyQuestions[currentQuestionIndex]["answerIndex"]) {  
        return Colors.green;  
      } else {
      return Colors.red;  
      } 
