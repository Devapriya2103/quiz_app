...
class _MathsScreenState extends State<MathsScreen> {
            ...
            Expanded(
              child: Padding(
                  ...
                  width: double.infinity,
                      ...
                      child: Stack(
                        children: [
                          Align(
                            alignment: Alignment.center,
                            child: Text(DummyDb.mathsQuestions[currentQuestionIndex]["question"],
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              fontSize: 15,
                              color: Colors.white,
                        ...
                        child: InkWell(
                          onTap: () {
                            if (selectedAnsIndex == null) {
                              ...
                              if (selectedAnsIndex ==
                              DummyDb.mathsQuestions[currentQuestionIndex]["answerIndex"]
                              ) {
                                rightAnsCount++;
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  Text(DummyDb.mathsQuestions[currentQuestionIndex]["options"][optionIndex],
                ...
                Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      if (currentQuestionIndex < DummyDb.mathsQuestions.length - 1) {
                      currentQuestionIndex++;
                      setState(() {});
  ...
  Color getColor (int clickedIndex) { 
    if (selectedAnsIndex != null) {
      if (DummyDb.mathsQuestions[currentQuestionIndex]["answerIndex"] == clickedIndex) {
        return Colors.green;
      }
    }
    if (selectedAnsIndex == clickedIndex) {
      if (selectedAnsIndex == DummyDb.mathsQuestions[currentQuestionIndex]["answerIndex"]) {  
        return Colors.green;  
      } else {
      return Colors.red;  
      } 
